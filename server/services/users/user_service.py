...
class UserService:
    ...
    def get_detailed_stats(username: str):
        ...
        for action in actions:
            try:
                if action.action == 'LOCKED_FOR_MAPPING':
                    ...
                    current_app.logger.info(duration)
                    current_app.logger.info(total_mapping_time)
        ...
        stats_dto.total_time_spent = str(datetime.timedelta(seconds=total_time))
        stats_dto.time_spent_mapping = str(datetime.timedelta(seconds=total_mapping_time))
        stats_dto.time_spent_validating = str(datetime.timedelta(seconds=total_validation_time))
