...
class Project(db.Model):
    ...
    def get_project_summary(self, preferred_locale) -> ProjectSummary:
        ...
        for user_duration in users_durations:
            ...
            # total_mapping_seconds = datetime.timedelta(hours=total_mapping_time.hour,
            ...
            # total_validation_seconds = datetime.timedelta(hours=total_validation_time.hour,
            ...
            summary.total_mapping_time = str(datetime.timedelta(seconds=total_mapping_time))
            summary.total_validation_time = str(datetime.timedelta(seconds=total_validation_time))
            summary.total_time_spent = str(datetime.timedelta(seconds=total_time_spent))
