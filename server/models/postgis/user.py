...
class User(db.Model):
    ...
    def as_dto(self, logged_in_username: str) -> UserDTO:
        ...
        user_dto.total_time_spent = str(datetime.timedelta(seconds=total_time))
        user_dto.time_spent_mapping = str(datetime.timedelta(seconds=total_mapping_time))
        user_dto.time_spent_validating = str(datetime.timedelta(seconds=total_validation_time))
